...
return {
	...
	_: {
		...
		nodes: [
			...
			__memo(() => import('./chunks/1-BUt4Ruct.js')),
			__memo(() => import('./chunks/2-Dt_35uiy.js')),
			__memo(() => import('./chunks/3-B3aZUVE3.js')),
			__memo(() => import('./chunks/4-CYKfGIjc.js')),
			__memo(() => import('./chunks/5-BMj6REBa.js')),
			__memo(() => import('./chunks/6-CvXvfgt9.js')),
			__memo(() => import('./chunks/7-BGZPA4oU.js')),
			...
			__memo(() => import('./chunks/13-D9EaWZq0.js')),
			__memo(() => import('./chunks/14-DY2QkulB.js')),
			__memo(() => import('./chunks/15-9-WMcDeI.js')),
			__memo(() => import('./chunks/16-DCIc3eSr.js')),
			...
			__memo(() => import('./chunks/27-CAPiK1Ec.js')),
