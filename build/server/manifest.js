...
return {
	...
	_: {
		...
		nodes: [
			...
			__memo(() => import('./chunks/14-B61EMVQn.js')),
			__memo(() => import('./chunks/15-B4370QEt.js')),
			__memo(() => import('./chunks/16-eg9VbvSp.js')),
			__memo(() => import('./chunks/17-DeSs5_M2.js')),
			__memo(() => import('./chunks/18-BCxBfYfW.js')),
			__memo(() => import('./chunks/19-DeOdBJNo.js')),
			__memo(() => import('./chunks/20-X5YjDIKS.js')),
			__memo(() => import('./chunks/21-ChiAAtaj.js')),
			__memo(() => import('./chunks/22-BUSFDLRv.js')),
			__memo(() => import('./chunks/23-Cb873g2g.js')),
			__memo(() => import('./chunks/24-BRQ21tHP.js')),
			...
			__memo(() => import('./chunks/30-B3aRaFI7.js')),
