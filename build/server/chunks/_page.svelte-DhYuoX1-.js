import { s as store_get, c as ensure_array_like, u as unsubscribe_stores, f as bind_props } from './index2-CW9yIE9Z.js';
...
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    $$renderer2.push(`<div class="dashboard-hero-page svelte-qewru5"><div class="hero-inner-page svelte-qewru5"><button class="hero-hamburger-page svelte-qewru5" aria-label="Open sidebar"><svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#111827" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="3" y1="12" x2="21" y2="12"></line><line x1="3" y1="6" x2="21" y2="6"></line><line x1="3" y1="18" x2="21" y2="18"></line></svg></button> <h1 class="hero-title-page svelte-qewru5">Dashboard Overview</h1></div></div> <div class="recent-activity-compact svelte-qewru5" aria-live="polite"><div class="recent-stats-row svelte-qewru5"><div class="stat-tile svelte-qewru5"><div class="stat-value svelte-qewru5">${escape_html(recentActivity.activeGuestPasses)}</div> <div class="stat-label svelte-qewru5">Guest Passes</div></div> <div class="stat-tile svelte-qewru5"><div class="stat-value svelte-qewru5">${escape_html(recentActivity.activeFoodDeliveryPasses)}</div> <div class="stat-label svelte-qewru5">Food Delivery</div></div> <div class="stat-tile stat-long svelte-qewru5"><div class="stat-value svelte-qewru5">${escape_html(recentActivity.recentCarAccess)}</div> <div class="stat-label svelte-qewru5">Recent Car</div></div> <a href="/user/dashboard/manage/system-overview" class="stat-toggle svelte-qewru5" title="Open system overview">Details</a></div> <div id="recent-activity-details" class="recent-activity-card svelte-qewru5" style="display:none; margin-top:0.75rem;"><h3 class="svelte-qewru5">Recent Activity</h3> <ul class="svelte-qewru5"><li class="svelte-qewru5"><strong>Active Guest Passes:</strong> ${escape_html(recentActivity.activeGuestPasses)}</li> <li class="svelte-qewru5"><strong>Active Food Delivery Passes:</strong> ${escape_html(recentActivity.activeFoodDeliveryPasses)}</li> <li class="svelte-qewru5"><strong>Recent Car Access:</strong> ${escape_html(recentActivity.recentCarAccess)}</li></ul></div></div> `);
...
//# sourceMappingURL=_page.svelte-DhYuoX1-.js.map
