import { V as attr_class, W as ensure_array_like, X as store_get, Y as slot, Z as unsubscribe_stores, _ as bind_props } from './index2-yPxTiqcs.js';
...
function _layout($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    $$renderer2.push(`<div class="user-layout svelte-1t2o3pe"><button class="sidebar-toggle svelte-1t2o3pe" aria-label="Open sidebar"><svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#232946" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="3" y1="12" x2="21" y2="12"></line><line x1="3" y1="6" x2="21" y2="6"></line><line x1="3" y1="18" x2="21" y2="18"></line></svg></button> `);
    {
      $$renderer2.push("<!--[!-->");
    }
    $$renderer2.push(`<!--]--> <aside${attr_class("sidebar svelte-1t2o3pe", void 0, { "open": sidebarOpen })} aria-label="Sidebar Navigation"><div class="sidebar-content svelte-1t2o3pe"><div class="user-profile svelte-1t2o3pe"><img${attr("src", userProfilePic)}${attr("alt", userName)} class="profile-pic svelte-1t2o3pe"/> <div class="user-username svelte-1t2o3pe">Resident</div></div> <nav class="sidebar-nav svelte-1t2o3pe" aria-label="Main Navigation"><!--[-->`);
    ...
    bind_props($$props, { recentActivity, load });
  });
}

export { _layout as default };
//# sourceMappingURL=_layout.svelte-BbdyyJiY.js.map
