...
const index = 22;
let component_cache;
const component = async () => component_cache ??= (await import('./_page.svelte-BjQVe09N.js')).default;
...
const stylesheets = ["_app/immutable/assets/22.Dxm5GUdE.css"];
const fonts = [];

export { component, fonts, imports, index, _page_server_ts as server, server_id, stylesheets };
//# sourceMappingURL=22-BIYujeE5.js.map
