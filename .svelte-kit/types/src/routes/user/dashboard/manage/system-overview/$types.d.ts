...
type RouteParams = {  };
type RouteId = '/user/dashboard/manage/system-overview';
...
export type PageServerData = Expand<OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../../../src/routes/user/dashboard/manage/system-overview/+page.server.js').load>>>>>>;
