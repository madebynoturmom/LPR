...
type RouteParams = {  };
type RouteId = '/admin/dashboard/manage/system-overview';
...
export type PageServerData = Expand<OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../../../src/routes/admin/dashboard/manage/system-overview/+page.server.js').load>>>>>>;
