...
type LayoutRouteId = RouteId | "/" | "/admin/dashboard" | "/admin/dashboard/admins" | "/admin/dashboard/admins/create" | "/admin/dashboard/events" | "/admin/dashboard/guards" | "/admin/dashboard/guards/create" | "/admin/dashboard/guests" | "/admin/dashboard/residents" | "/admin/dashboard/residents/[id]" | "/admin/dashboard/residents/[id]/edit" | "/admin/dashboard/residents/create" | "/admin/dashboard/settings" | "/admin/dashboard/vehicles" | "/admin/dashboard/vehicles/create" | "/login" | "/logout" | "/user/dashboard" | "/user/dashboard/food-delivery" | "/user/dashboard/guests" | "/user/dashboard/guests/create" | "/user/dashboard/profile" | "/user/dashboard/vehicles" | "/user/dashboard/vehicles/[id]/delete" | "/user/dashboard/vehicles/[id]/edit" | "/user/dashboard/vehicles/create" | null
