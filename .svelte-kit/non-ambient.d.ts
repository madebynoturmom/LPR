...
declare module "$app/types" {
	export interface AppTypes {
		RouteId(): "/" | "/admin" | "/admin/dashboard" | "/admin/dashboard/admins" | "/admin/dashboard/admins/create" | "/admin/dashboard/events" | "/admin/dashboard/guards" | "/admin/dashboard/guards/create" | "/admin/dashboard/guests" | "/admin/dashboard/residents" | "/admin/dashboard/residents/create" | "/admin/dashboard/residents/[id]" | "/admin/dashboard/residents/[id]/delete" | "/admin/dashboard/residents/[id]/edit" | "/admin/dashboard/settings" | "/admin/dashboard/vehicles" | "/admin/dashboard/vehicles/create" | "/api" | "/api/food-delivery" | "/api/food-delivery/create" | "/api/recent-activity" | "/login" | "/logout" | "/user" | "/user/dashboard" | "/user/dashboard/food-delivery" | "/user/dashboard/food-delivery/create" | "/user/dashboard/guests" | "/user/dashboard/guests/create" | "/user/dashboard/profile" | "/user/dashboard/vehicles" | "/user/dashboard/vehicles/create" | "/user/dashboard/vehicles/[id]" | "/user/dashboard/vehicles/[id]/delete" | "/user/dashboard/vehicles/[id]/edit";
		RouteParams(): {
		...
		Pathname(): "/" | "/admin" | "/admin/" | "/admin/dashboard" | "/admin/dashboard/" | "/admin/dashboard/admins" | "/admin/dashboard/admins/" | "/admin/dashboard/admins/create" | "/admin/dashboard/admins/create/" | "/admin/dashboard/events" | "/admin/dashboard/events/" | "/admin/dashboard/guards" | "/admin/dashboard/guards/" | "/admin/dashboard/guards/create" | "/admin/dashboard/guards/create/" | "/admin/dashboard/guests" | "/admin/dashboard/guests/" | "/admin/dashboard/residents" | "/admin/dashboard/residents/" | "/admin/dashboard/residents/create" | "/admin/dashboard/residents/create/" | `/admin/dashboard/residents/${string}` & {} | `/admin/dashboard/residents/${string}/` & {} | `/admin/dashboard/residents/${string}/delete` & {} | `/admin/dashboard/residents/${string}/delete/` & {} | `/admin/dashboard/residents/${string}/edit` & {} | `/admin/dashboard/residents/${string}/edit/` & {} | "/admin/dashboard/settings" | "/admin/dashboard/settings/" | "/admin/dashboard/vehicles" | "/admin/dashboard/vehicles/" | "/admin/dashboard/vehicles/create" | "/admin/dashboard/vehicles/create/" | "/api" | "/api/" | "/api/food-delivery" | "/api/food-delivery/" | "/api/food-delivery/create" | "/api/food-delivery/create/" | "/api/recent-activity" | "/api/recent-activity/" | "/login" | "/login/" | "/logout" | "/logout/" | "/user" | "/user/" | "/user/dashboard" | "/user/dashboard/" | "/user/dashboard/food-delivery" | "/user/dashboard/food-delivery/" | "/user/dashboard/food-delivery/create" | "/user/dashboard/food-delivery/create/" | "/user/dashboard/guests" | "/user/dashboard/guests/" | "/user/dashboard/guests/create" | "/user/dashboard/guests/create/" | "/user/dashboard/profile" | "/user/dashboard/profile/" | "/user/dashboard/vehicles" | "/user/dashboard/vehicles/" | "/user/dashboard/vehicles/create" | "/user/dashboard/vehicles/create/" | `/user/dashboard/vehicles/${string}` & {} | `/user/dashboard/vehicles/${string}/` & {} | `/user/dashboard/vehicles/${string}/delete` & {} | `/user/dashboard/vehicles/${string}/delete/` & {} | `/user/dashboard/vehicles/${string}/edit` & {} | `/user/dashboard/vehicles/${string}/edit/` & {};
		ResolvedPathname(): `${"" | `/${string}`}${ReturnType<AppTypes['Pathname']>}`;
		Asset(): "/default-profile.png" | "/icons/food-delivery.svg" | "/icons/guest-passes.svg" | "/icons/vehicles.svg" | "/robots.txt" | "/uploads/admin_A001_1758129885580_monitor.png" | string & {};
	}
}