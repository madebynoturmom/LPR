import * as server from '../entries/pages/user/dashboard/food-delivery/create/_page.server.ts.js';

export const index = 26;
let component_cache;
export const component = async () => component_cache ??= (await import('../entries/pages/user/dashboard/food-delivery/create/_page.svelte.js')).default;
export { server };
export const server_id = "src/routes/user/dashboard/food-delivery/create/+page.server.ts";
...
export const stylesheets = ["_app/immutable/assets/26.JdnQOfNv.css"];
export const fonts = [];
