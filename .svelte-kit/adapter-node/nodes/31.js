import * as server from '../entries/pages/user/dashboard/guests/create/_page.server.ts.js';

export const index = 31;
let component_cache;
export const component = async () => component_cache ??= (await import('../entries/pages/user/dashboard/guests/create/_page.svelte.js')).default;
export { server };
export const server_id = "src/routes/user/dashboard/guests/create/+page.server.ts";
...
export const stylesheets = ["_app/immutable/assets/31.BKAeounY.css"];
export const fonts = [];
